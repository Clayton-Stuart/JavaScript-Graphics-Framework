...
function returnGridSize(id) {
    console.log('Grid Width(px): ', document.getElementById(id).offsetWidth, 'px');
    console.log('Grid Height(px): ', document.getElementById(id).offsetHeight, 'px');
    console.log('Pixel Width(px): ', document.getElementById(id).children[0].children[0].offsetWidth, 'px');
    console.log('Pixel Height(px): ', document.getElementById(id).children[0].offsetHeight, 'px');
    console.log('Pixel Amount(width): ', document.getElementById(id).children[0].children.length, 'units');
    console.log('Pixel Amount(height): ', document.getElementById(id).children.length, 'units');
    return {
